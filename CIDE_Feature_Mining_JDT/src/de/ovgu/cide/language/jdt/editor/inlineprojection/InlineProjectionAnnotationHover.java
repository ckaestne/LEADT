...
class InlineProjectionAnnotationHover implements IAnnotationHover,
	...
	public String getHoverInfo(ISourceViewer sourceViewer, int lineNumber) {
		// this is a no-op as semantics is defined by the implementation of the
		// annotation hover extension
		return null;
	}
	 ...
	 * @since 3.1
	 */
	private boolean isCaptionLine(InlineProjectionAnnotation annotation,
	...
	/*
	 * @see
	 * org.eclipse.jface.text.source.IAnnotationHoverExtension#getHoverInfo(
	...
	/*
	 * @see
	 * org.eclipse.jface.text.source.IAnnotationHoverExtension#getHoverLineRange
	 * (org.eclipse.jface.text.source.ISourceViewer, int)
	 */
	...
	/*
	 * @see
	 * org.eclipse.jface.text.source.IAnnotationHoverExtension#canHandleMouseCursor
	 * ()
	 */
	...
	/*
	 * @seeorg.eclipse.jface.text.source.IAnnotationHoverExtension#
	...
	public IInformationControlCreator getHoverControlCreator() {
		...
		return new IInformationControlCreator() {
			public IInformationControl createInformationControl(Shell parent) {
				return new SourceViewerInformationControl(parent, true,
						SWT.NONE, JFaceResources.TEXT_FONT);
			}
		};
	}
}
