...
public class AMethodAccessElement extends AAbstractElement
{

	protected AMethodAccessElement( UnifiedASTNode node, int compUnitHash)
	{
	...
	{
		return AICategories.METHOD_ACCESS;
	}
	...
	{
		if( !(pObject instanceof AMethodAccessElement))
			return false;
		else
			return getId().equals(((AMethodAccessElement)pObject).getId() );
	}
