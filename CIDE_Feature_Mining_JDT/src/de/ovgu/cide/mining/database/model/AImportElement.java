...
public class AImportElement extends AAbstractElement
{

	protected AImportElement( UnifiedASTNode node, int compUnitHash)
	{
	...
	{
		if( !(pObject instanceof AImportElement))
			return false;
		else
			return getId().equals(((AImportElement)pObject).getId() );
	}
