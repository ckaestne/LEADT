...
public class ACompilationUnitElement extends AAbstractElement
{

	protected ACompilationUnitElement( UnifiedASTNode node, int compUnitHash)
	{
	...
	{
		return AICategories.COMPILATION_UNIT;
	}
	...
	{
		if( !(pObject instanceof ACompilationUnitElement))
			return false;
		else
			return getId().equals(((ACompilationUnitElement)pObject).getId() );
	}
