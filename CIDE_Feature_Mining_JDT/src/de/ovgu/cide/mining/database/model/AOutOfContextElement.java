 ...
 */
public class AOutOfContextElement extends AAbstractElement
{
	 ...
	 */
	protected AOutOfContextElement(UnifiedASTNode node, int compUnitHash)
	{
	...
	{
		return AICategories.OUT_OF_CONTEXT;
	}
	...
	{
		if( !(pObject instanceof AOutOfContextElement))
			return false;
		else
			return getId().equals(((AOutOfContextElement)pObject).getId() );
	}
