...
public class ATypeAccessElement extends AAbstractElement
{

	protected ATypeAccessElement( UnifiedASTNode node, int compUnitHash)
	{
	...
	{
		return AICategories.TYPE_ACCESS;
	}
	...
	{
		if( !(pObject instanceof ATypeAccessElement))
			return false;
		else
			return getId().equals(((ATypeAccessElement)pObject).getId() );
	}
