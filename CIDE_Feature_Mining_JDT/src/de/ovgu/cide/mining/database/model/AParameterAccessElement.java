...
public class AParameterAccessElement extends AAbstractElement
{

	protected AParameterAccessElement( UnifiedASTNode node, int compUnitHash)
	{
	...
	{
		return AICategories.PARAMETER_ACCESS;
	}
	...
	{
		if( !(pObject instanceof AParameterAccessElement))
			return false;
		else
			return getId().equals(((AParameterAccessElement)pObject).getId() );
	}
