...
public class ALocalVariableAccessElement extends AAbstractElement
{

	protected ALocalVariableAccessElement( UnifiedASTNode node, int compUnitHash)
	{
	...
	{
		return AICategories.LOCAL_VARIABLE_ACCESS;
	}
	...
	{
		if( !(pObject instanceof ALocalVariableAccessElement))
			return false;
		else
			return getId().equals(((ALocalVariableAccessElement)pObject).getId() );
	}
