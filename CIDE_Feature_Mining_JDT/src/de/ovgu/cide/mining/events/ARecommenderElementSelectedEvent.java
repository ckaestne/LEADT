...
public class ARecommenderElementSelectedEvent extends EventObject {
	...
	public ARecommenderElementSelectedEvent(Object source, IFeature color,  int cuHash) {
	...
	public ARecommenderElementSelectedEvent(Object source, IFeature color, int start, int end, int cuHash) {
		this(source,EVENT_TYPE.AST,color,start,end,cuHash);
	}
		
	public ARecommenderElementSelectedEvent(Object source, EVENT_TYPE type,  IFeature color, int start, int end, int cuHash) {
		super(source);
		this.type = type;
		this.start = start;
		this.end = end;
