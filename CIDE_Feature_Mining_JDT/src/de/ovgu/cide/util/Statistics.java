...
//	
	...
	public static Set<String> loadFeatureElements(boolean expanded) {
		...
		if (expanded)
			elements = readStringArray(importPath+curFeature+"/Elements_expanded.txt");
		else
			elements = readStringArray(importPath+curFeature+"/Elements_original.txt");
	...
	public static Set<String> loadDependentFeatureElements(String featurePath, boolean expanded) {
		String[] elements = null;
		
		if (expanded)
			elements = readStringArray(importPath+featurePath+"/Elements_expanded.txt");
		else
			elements = readStringArray(importPath+featurePath+"/Elements_original.txt");
	...
	public static void writeRecommendations(String line, String row) {
		...
		try {
			...
			out = new BufferedWriter(new OutputStreamWriter(
					new FileOutputStream(f.getAbsolutePath()+"/Recommendations-line.txt", true), "ISO-8859-1"));
			...
			out = new BufferedWriter(new OutputStreamWriter(
					new FileOutputStream(f.getAbsolutePath()+"/Recommendations-row.txt", true), "ISO-8859-1"));
			content = row;
