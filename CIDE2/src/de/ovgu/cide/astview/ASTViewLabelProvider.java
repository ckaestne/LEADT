...
//	}
	...
	public Image getImage( Object pObject )
	{
		...
		if (pObject instanceof IASTNode) {
			IASTNode node = ((ASTNode)pObject);
			
			
			//System.out.println( "id: " + node.getDisplayName() + " --> " + node.getId() );
			
			
		    lReturn = PlatformUI.getWorkbench().getSharedImages().getImage( ISharedImages.IMG_OBJ_FILE );
